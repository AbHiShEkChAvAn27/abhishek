            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:contact@example.com" className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    contact@example.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="bg-slate-200 dark:bg-slate-700 p-3 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                  aria-label="GitHub"
                >
